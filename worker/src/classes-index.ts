...
//
// Progress: 32 / 419 ISIC Rev.4 4-digit classes implemented.
// Completed groups: 011, 012, 013, 014, 015, 016, 017 (Division 01), 021, 022.
...
export const COMPLETED_GROUPS: string[] = ["011", "012", "013", "014", "015", "016", "017", "021", "022"];
